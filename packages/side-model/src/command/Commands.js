  ...
  [
    'addSelection',
    {
      ...
      description: `Add a selection to a set of options in a 
        ...
        Option locators provide different ways of specifying a select element (e.g., label=, value=, id=, index=) This command is NOT SUPPORTED by Holm Security`,
  ...
  [
    'runScript',
    {
      ...
      description: `Creates a new "script" tag in the body of the current 
        ...
        if there is any chance that the script will throw an exception. This command is NOT SUPPORTED by Holm Security`,
      target: ArgTypes.script,
    },
  ],
  [
  ...
  [
    'verifyValue',
    {
      ...
      description: `Soft assert the (whitespace-trimmed) value of an input 
        ...
        element is checked or not. The test will continue even if the verify fails. This command is NOT SUPPORTED by Holm Security`,
      target: ArgTypes.locator,
      value: ArgTypes.pattern,
    },
  ],
